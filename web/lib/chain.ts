...
// `||`, not `??`: Vercel bakes an env var that is *declared but blank* in as "", which is not
// nullish and would slip past `??` — reinstating the "trading is not configured" placeholder on a
// deployment that looks correctly configured.
...
export const SWAP_ROUTER = (process.env.NEXT_PUBLIC_SWAP_ROUTER ||
  "0x9140a78c1A137c7fF1c151EC8231272aF78a99A4") as Address;
